...
LOCAL_APPS = [
    ...
    "site_statistics",  # Integrated statistics and analytics system
]
...
CORS_ALLOWED_ORIGINS = config("CORS_ALLOWED_ORIGINS", default="http://localhost:10100,http://127.0.0.1:10100").split(
    ","
)
...
# CSRF Configuration
CSRF_TRUSTED_ORIGINS = config("CSRF_TRUSTED_ORIGINS", default="http://localhost:10100,http://127.0.0.1:10100").split(
    ","
)
...
CELERY_BEAT_SCHEDULE = {
    ...
    "aggregate-statistics-daily": {
        "task": "site_statistics.tasks.aggregate_daily_stats",
...
PLAYWRIGHT_SERVICE_URL = config("PLAYWRIGHT_SERVICE_URL", default="http://localhost:10107")
