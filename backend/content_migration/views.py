...
from .models import MigrationJob, MigrationPlan, MigrationTask
from .serializers import MigrationJobSerializer, MigrationPlanSerializer, MigrationTaskSerializer
...
class MigrationPlanViewSet(viewsets.ModelViewSet):
    ...
    def run(self, request, pk=None):
        ...
        job = MigrationJob.objects.create(plan=plan, tenant=request.tenant, created_by=request.user)
