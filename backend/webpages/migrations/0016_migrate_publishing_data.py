...
def migrate_publishing_data_forward(apps, schema_editor):
    ...
    for page in WebPage.objects.filter(publication_status='published'):
        ...
        if current_version:
            ...
            page_data = {
                ...
                "expiry_date": page.expiry_date.isoformat() if page.expiry_date else None,
    ...
    print(f"Migration completed: {migrated_count} versions updated, {created_versions_count} versions created")
...
def migrate_publishing_data_reverse(apps, schema_editor):
    ...
    print("Reverse migration completed: cleared effective_date and expiry_date from all versions")
