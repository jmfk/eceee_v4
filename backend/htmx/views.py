...
def dynamic_content(request):
    ...
    response['HX-Toast'] = f'Content loaded successfully (Request #{context["request_count"]})'
...
def search_example(request):
    ...
    sample_data = [
        {'id': 1, 'title': 'Django REST Framework', 'description': 'Powerful API development toolkit', 'category': 'Backend'},
        {'id': 2, 'title': 'React', 'description': 'JavaScript library for building user interfaces', 'category': 'Frontend'},
        {'id': 3, 'title': 'PostgreSQL', 'description': 'Advanced open source relational database', 'category': 'Database'},
        {'id': 4, 'title': 'Docker', 'description': 'Platform for developing, shipping, and running applications', 'category': 'DevOps'},
        {'id': 5, 'title': 'HTMX', 'description': 'High power tools for HTML', 'category': 'Frontend'},
        {'id': 6, 'title': 'Tailwind CSS', 'description': 'Utility-first CSS framework', 'category': 'Frontend'},
        {'id': 7, 'title': 'Redis', 'description': 'In-memory data structure store', 'category': 'Database'},
        {'id': 8, 'title': 'Celery', 'description': 'Distributed task queue', 'category': 'Backend'},
        {'id': 9, 'title': 'nginx', 'description': 'HTTP and reverse proxy server', 'category': 'DevOps'},
        {'id': 10, 'title': 'Git', 'description': 'Distributed version control system', 'category': 'DevOps'},
    ]
...
def infinite_scroll(request):
    ...
    for i in range(start_item, end_item + 1):
        items.append({
            ...
            'timestamp': timezone.now(),
            'category': random.choice(['Technology', 'Science', 'Art', 'Business', 'Education'])
        })
