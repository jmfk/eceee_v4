...
class Orderable(models.Model):
    ...
    def next(self):
        ...
        return (
            self.get_filtered_manager()
            .filter(sort_order__gt=self.sort_order)
            .order_by("sort_order")
            .first()
        )
    ...
    def prev(self):
        ...
        return (
            self.get_filtered_manager()
            .filter(sort_order__lt=self.sort_order)
            .order_by("-sort_order")
            .first()
        )
    ...
    def sort_order_display(self):
        ...
        return mark_safe(template.format(self.id, self.sort_order))
