 ...
 * 
 * This file imports ECEEE-specific layout definitions that mirror the backend eceee_layouts app.
...
/**
 * ECEEE Layout Registry - Maps layout names to React components
 */
...
export const getLayoutComponent = (layoutName) => {
    const layout = ECEEE_LAYOUT_REGISTRY[layoutName];
...
export const getLayoutMetadata = (layoutName) => {
    return ECEEE_LAYOUT_REGISTRY[layoutName] || null;
};
...
export const getAvailableLayouts = () => {
    return Object.values(ECEEE_LAYOUT_REGISTRY);
};
...
export const layoutExists = (layoutName) => {
    return layoutName in ECEEE_LAYOUT_REGISTRY;
};
