...
const collectWidgetMetadata = (WidgetComponent, overrideWidgetType = null) => {
    return {
        ...
        widgetType: overrideWidgetType || WidgetComponent.widgetType || `eceee_widgets.${WidgetComponent.displayName}`,
 ...
 * 
 * @param {React.Component} WidgetComponent - The widget component
 * @param {string} [customWidgetType] - Optional custom widget type (e.g., 'eceee_widgets.ContentWidget')
