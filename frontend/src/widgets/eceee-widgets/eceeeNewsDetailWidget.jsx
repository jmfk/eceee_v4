 ...
 * Widget type: eceee_widgets.NewsDetailWidget
 */

import React from 'react';
import { FileText } from 'lucide-react';

const eceeeNewsDetailWidget = ({
    config = {},
    mode = 'display',
    widgetId,
    ...props
...
// === METADATA ===
eceeeNewsDetailWidget.displayName = 'News Detail';
eceeeNewsDetailWidget.widgetType = 'eceee_widgets.NewsDetailWidget';
...
// Display metadata
eceeeNewsDetailWidget.metadata = {
    name: 'News Detail',
...
export default eceeeNewsDetailWidget;
