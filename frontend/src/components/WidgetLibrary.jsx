    ...
    if (error) {
        return (
            <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                <div className="text-red-800 font-medium" role="heading" aria-level="3">Error Loading Widget Types</div>
        ...
        <div className="space-y-4">
            ...
            {filteredWidgets.length === 0 && (
                <div className="text-center py-8">
                    ...
                    <div className="text-gray-500 font-medium" role="heading" aria-level="3">No widget types found</div>
            ...
            <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-start space-x-2">
                    ...
                    <div>
                        <div className="text-blue-800 text-sm font-medium">Code-Based Widget Types</div>
