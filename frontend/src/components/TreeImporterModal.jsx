                        ...
                        <div className="p-4 bg-blue-50 border border-blue-200 rounded-md space-y-3">
                            ...
                            {progress.currentUrl && (
                                <div className="p-2 bg-white rounded border border-blue-200">
                                    ...
                                    <p className="text-xs text-blue-700 truncate">{progress.currentUrl}</p>
                                </div>
                            )}
                                    ...
                                    <div className="bg-white rounded p-2 border border-green-200">
                                        ...
                                        <div className="max-h-20 overflow-y-auto space-y-0.5">
                                            {progress.urlsCompleted.slice(-10).map((url, idx) => (
                                                <p key={idx} className="text-xs text-green-700 truncate">
                                                    {url}
                                                </p>
                                            ))}
                                        </div>
                                        ...
                                        <div className="max-h-24 overflow-y-auto space-y-1">
                                            {progress.urlsFailed.map((item, idx) => (
                                                <div key={idx} className="text-xs">
                                                    <p className="text-red-700 truncate font-medium">{item.url}</p>
                                                    <p className="text-red-600 text-xs ml-2">{item.error}</p>
                                                </div>
                                            ))}
                                        </div>
