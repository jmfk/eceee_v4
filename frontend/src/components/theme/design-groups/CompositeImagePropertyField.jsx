...
const CompositeImagePropertyField = ({
    ...
    const backgroundSize = value?.backgroundSize || '';
    const backgroundPosition = value?.backgroundPosition || '';
    const backgroundRepeat = value?.backgroundRepeat || '';
    ...
    const handleImageChange = (newImageData) => {
        ...
        onChange({
            ...value,
            ...newImageData,
            // Preserve existing CSS properties (no defaults, rely on widget CSS)
    ...
    return (
        <div className="space-y-2">
            ...
            {/* Background CSS Properties (collapsible) */}
            {imageUrl && (
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                    <button
                        type="button"
                        onClick={() => setIsExpanded(!isExpanded)}
                        className="w-full flex items-center justify-between px-3 py-2 bg-gray-50 hover:bg-gray-100 transition text-sm font-medium text-gray-700"
                    >
