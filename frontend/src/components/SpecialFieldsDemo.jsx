        ...
        <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 p-6">
                    ...
                    <div>
                        ...
                        <div className="mt-4 space-y-2">
                            <div className="text-sm font-medium text-gray-900" role="heading" aria-level="5">Special Field Types:</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    ...
                    <div className="font-medium text-blue-900" role="heading" aria-level="4">Command Palette</div>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                    ...
                    <div className="font-medium text-green-900" role="heading" aria-level="4">Combobox</div>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                    ...
                    <div className="font-medium text-purple-900" role="heading" aria-level="4">Mentions</div>
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                    ...
                    <div className="font-medium text-orange-900" role="heading" aria-level="4">Tree Select</div>
                ...
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                    ...
                    <div className="font-medium text-red-900" role="heading" aria-level="4">Transfer List</div>
            ...
            <div className="bg-gradient-to-r from-gray-50 to-blue-50 border border-gray-200 rounded-lg p-6">
                <div className="text-lg font-medium text-gray-900 mb-4" role="heading" aria-level="3">Usage Tips</div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div>
                        <div className="font-medium text-gray-900 mb-2" role="heading" aria-level="4">Keyboard Navigation</div>
                    ...
                    <div>
                        <div className="font-medium text-gray-900 mb-2" role="heading" aria-level="4">Special Interactions</div>
                        <div className="space-y-1 text-gray-600" role="list">
