/**
 * WysiwygToolbarManager - Global singleton for managing WYSIWYG editor toolbar
 * 
 * This manager handles:
 * - Tracking the currently active editor instance
...
class WysiwygToolbarManager {
     ...
     * @param {Object} editorInstance - The ContentWidgetEditorRenderer instance
     */
    ...
    dispatchCommand(command, value) {
        if (this.activeEditor && this.activeEditor.editorElement) {
            const event = new CustomEvent('wysiwyg-command', {
                detail: { command, value }
            });
            this.activeEditor.editorElement.dispatchEvent(event);
        }
    }
...
export const toolbarManager = new WysiwygToolbarManager();
